define('userfrmAllEventsController',{
    eventList: null,
    /**
     * @function onNavigate
    ...
    onEventRemove: function(event) {
        try {
            ...
            function handleAlert(response) {
                if (response) this.delete("event", this.getEventsData, this.eventsToDel);
            }
        } catch (error) {
            kony.print("FrmAllEvents Controller" + JSON.stringify(error));
        }
    ...
    animateDetailsPage: function(left) {
        try {
            this.view.eventpreview.animate(kony.ui.createAnimation({
                100: {
                    left: left + "%",
                    "stepConfig": {}
                }
...
define('frmAllEventsControllerActions',{
    /*
...
define('frmAllEventsController',["userfrmAllEventsController","frmAllEventsControllerActions"],
		function(){
