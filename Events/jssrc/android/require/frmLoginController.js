define("userfrmLoginController", {
        ...
        try {
            ...
            auth_client.login({
                ...
                auth_client.getUserAttributes(function(result) {
                    ...
                    kony.net.clearCookies("https://www.linkedin.com");
    ...
    animateBrowserFlex: function(top) {
        try {
            this.view.flxBrowserContainer.animate(kony.ui.createAnimation({
                100: {
                    top: top + "%",
                    "stepConfig": {}
                }
    ...
    checkAndCreateUser: function() {
        try {
            ...
            objSvc.fetch(options, this.checkUserSuccessCallback.bind(this), this.checkUserFailureCallback.bind(this));
        } catch (error) {
            kony.print("frm Event Login Controller" + JSON.stringify(error));
        }
    },
    ...
    createUser: function() {
        try {
            ...
            objSvc.create(options, this.createUserSuccessCallback.bind(this), this.createUserFailureCallback.bind(this));
        } catch (error) {
            kony.print("frm Event Login Controller" + JSON.stringify(error));
        }
    },
    ...
    createRegistration: function() {
        try {
            ...
            objSvc.create(options, this.createRegistrationSuccessCallback.bind(this), this.createRegistrationFailureCallback.bind(this));
        } catch (error) {
            kony.print("frm Event Login Controller" + JSON.stringify(error));
        }
    },
    ...
    isUserAlreadyRegistered: function() {
        try {
            ...
            objSvc.fetch(options, this.isUserRegSuccessCallback.bind(this), this.isUserRegFailureCallback.bind(this));
        } catch (error) {
            kony.print("frm Event Login Controller" + JSON.stringify(error));
        }
    },
