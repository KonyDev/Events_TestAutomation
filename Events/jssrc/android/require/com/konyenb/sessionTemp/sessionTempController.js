define("com/konyenb/sessionTemp/usersessionTempController", function() {
    return {
        ...
        getSessionData: function() {
            try {
                ...
                if (this.sessionAndSpeakerData !== "" && this.sessionAndSpeakerData.session_id !== undefined && this.sessionAndSpeakerData.session_id !== "") this.sessionData.session_id = this.sessionAndSpeakerData.session_id;
        ...
        getSpeakerData: function() {
            try {
                ...
                if (this.speakers.length > 0) this.sessionFullData.speakers = this.speakers;
                return this.sessionFullData;
            } catch (error) {
                kony.print("session template controller" + JSON.stringify(error));
            }
        ...
        getData: function() {
            try {
                if (this.getSessionData() === undefined) return;
                return this.sessionFullData;
            } catch (error) {
                kony.print("session template controller" + JSON.stringify(error));
            }
        ...
        setDateRange: function(startDate, endDate, validStartTime, validEndTime) {
            try {
                ...
                if (this.view.calSessionStartDate.formattedDate === null) this.view.calSessionStartDate.dateComponents = date;
                date = endDate.split("/");
                var prevDate = this.view.calSessionStartDate.formattedDate;
                this.view.calSessionStartDate.validEndDate = [date[2], date[1], date[0]];
                if (this.view.calSessionStartDate.formattedDate === null) this.view.calSessionStartDate.dateComponents = [date[2], date[1], date[0]];
...
define("com/konyenb/sessionTemp/sessionTempControllerActions", {
    /*
...
define("com/konyenb/sessionTemp/sessionTempController", ["com/konyenb/sessionTemp/usersessionTempController", "com/konyenb/sessionTemp/sessionTempControllerActions"], function() {
